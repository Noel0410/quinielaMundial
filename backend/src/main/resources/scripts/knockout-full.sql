...
(gen_random_uuid(), 'Dieciseisavos', 5, (SELECT id FROM teams WHERE short_name = 'BEL'), (SELECT id FROM teams WHERE short_name = '')),
(gen_random_uuid(), 'Dieciseisavos', 6, (SELECT id FROM teams WHERE short_name = 'USA'), (SELECT id FROM teams WHERE short_name = 'BIH')),
(gen_random_uuid(), 'Dieciseisavos', 7, (SELECT id FROM teams WHERE short_name = 'ESP'), (SELECT id FROM teams WHERE short_name = '')),
...
(gen_random_uuid(), 'Dieciseisavos', 13, (SELECT id FROM teams WHERE short_name = 'SUI'), (SELECT id FROM teams WHERE short_name = '')),
